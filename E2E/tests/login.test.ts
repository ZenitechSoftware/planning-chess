...
Scenario(
  "User is redirected to game page as spectator by pressing Shift Tab and then Enter",
  () => {
    I.amOnPage("/");
...
Scenario(
  "User is redirected to game page as spectator by pressing Tab and then Enter",
  () => {
    I.amOnPage("/");
    login.login(username.user1);
    I.pressKey("Tab");
